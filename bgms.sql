...
--
-- Host: localhost
-- Generation Time: Apr 29, 2014 at 02:45 PM
...
--
-- Table structure for table `vg0dr_assets`
--

DROP TABLE IF EXISTS `vg0dr_assets`;
CREATE TABLE IF NOT EXISTS `vg0dr_assets` (
...
--
-- Dumping data for table `vg0dr_assets`
--

INSERT INTO `vg0dr_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `vg0dr_associations`
--

DROP TABLE IF EXISTS `vg0dr_associations`;
CREATE TABLE IF NOT EXISTS `vg0dr_associations` (
...
--
-- Table structure for table `vg0dr_banner_clients`
--

DROP TABLE IF EXISTS `vg0dr_banner_clients`;
CREATE TABLE IF NOT EXISTS `vg0dr_banner_clients` (
...
--
-- Table structure for table `vg0dr_banner_tracks`
--

DROP TABLE IF EXISTS `vg0dr_banner_tracks`;
CREATE TABLE IF NOT EXISTS `vg0dr_banner_tracks` (
...
--
-- Table structure for table `vg0dr_banners`
--

DROP TABLE IF EXISTS `vg0dr_banners`;
CREATE TABLE IF NOT EXISTS `vg0dr_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `vg0dr_categories`
--

DROP TABLE IF EXISTS `vg0dr_categories`;
CREATE TABLE IF NOT EXISTS `vg0dr_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vg0dr_categories`
--

INSERT INTO `vg0dr_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 724, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_contact_details`
--

DROP TABLE IF EXISTS `vg0dr_contact_details`;
CREATE TABLE IF NOT EXISTS `vg0dr_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `vg0dr_content`
--

DROP TABLE IF EXISTS `vg0dr_content`;
CREATE TABLE IF NOT EXISTS `vg0dr_content` (
...
--
-- Table structure for table `vg0dr_content_rating`
--

DROP TABLE IF EXISTS `vg0dr_content_rating`;
CREATE TABLE IF NOT EXISTS `vg0dr_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `vg0dr_content_types`
--

DROP TABLE IF EXISTS `vg0dr_content_types`;
CREATE TABLE IF NOT EXISTS `vg0dr_content_types` (
...
--
-- Dumping data for table `vg0dr_content_types`
--

INSERT INTO `vg0dr_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `vg0dr_contentitem_tag_map`
--

DROP TABLE IF EXISTS `vg0dr_contentitem_tag_map`;
CREATE TABLE IF NOT EXISTS `vg0dr_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `vg0dr_contentitem_tag_map`
--

INSERT INTO `vg0dr_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_core_log_searches`
--

DROP TABLE IF EXISTS `vg0dr_core_log_searches`;
CREATE TABLE IF NOT EXISTS `vg0dr_core_log_searches` (
...
--
-- Table structure for table `vg0dr_extensions`
--

DROP TABLE IF EXISTS `vg0dr_extensions`;
CREATE TABLE IF NOT EXISTS `vg0dr_extensions` (
...
--
-- Dumping data for table `vg0dr_extensions`
--

INSERT INTO `vg0dr_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"6ab8ebad7394965182daae68bb9ff22a"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'yoo_master2', 'template', 'yoo_master2', '', 0, 1, 1, 0, '{"name":"yoo_master2","type":"template","creationDate":"March 2014","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"1.0.0","description":"Master theme of the YOOtheme club. It is based on YOOtheme''s Warp theme framework.","group":""}', '{"config":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_finder_filters`
--

DROP TABLE IF EXISTS `vg0dr_finder_filters`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_filters` (
...
--
-- Table structure for table `vg0dr_finder_links`
--

DROP TABLE IF EXISTS `vg0dr_finder_links`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links` (
...
--
-- Table structure for table `vg0dr_finder_links_terms0`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms0` (
...
--
-- Table structure for table `vg0dr_finder_links_terms1`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms2`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms3`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms4`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms5`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms6`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms7`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms8`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_terms9`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termsa`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termsb`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termsc`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termsd`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termse`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_links_termsf`
--

DROP TABLE IF EXISTS `vg0dr_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `vg0dr_finder_taxonomy`
--

DROP TABLE IF EXISTS `vg0dr_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `vg0dr_finder_taxonomy`
--

INSERT INTO `vg0dr_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `vg0dr_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `vg0dr_finder_terms`
--

DROP TABLE IF EXISTS `vg0dr_finder_terms`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_terms` (
...
--
-- Table structure for table `vg0dr_finder_terms_common`
--

DROP TABLE IF EXISTS `vg0dr_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `vg0dr_finder_terms_common`
--

INSERT INTO `vg0dr_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `vg0dr_finder_tokens`
--

DROP TABLE IF EXISTS `vg0dr_finder_tokens`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `vg0dr_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `vg0dr_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `vg0dr_finder_types`
--

DROP TABLE IF EXISTS `vg0dr_finder_types`;
CREATE TABLE IF NOT EXISTS `vg0dr_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `vg0dr_languages`
--

DROP TABLE IF EXISTS `vg0dr_languages`;
CREATE TABLE IF NOT EXISTS `vg0dr_languages` (
...
--
-- Dumping data for table `vg0dr_languages`
--

INSERT INTO `vg0dr_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_menu`
--

DROP TABLE IF EXISTS `vg0dr_menu`;
CREATE TABLE IF NOT EXISTS `vg0dr_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vg0dr_menu`
--

INSERT INTO `vg0dr_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `vg0dr_menu_types`
--

DROP TABLE IF EXISTS `vg0dr_menu_types`;
CREATE TABLE IF NOT EXISTS `vg0dr_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vg0dr_menu_types`
--

INSERT INTO `vg0dr_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `vg0dr_messages`
--

DROP TABLE IF EXISTS `vg0dr_messages`;
CREATE TABLE IF NOT EXISTS `vg0dr_messages` (
...
--
-- Table structure for table `vg0dr_messages_cfg`
--

DROP TABLE IF EXISTS `vg0dr_messages_cfg`;
CREATE TABLE IF NOT EXISTS `vg0dr_messages_cfg` (
...
--
-- Table structure for table `vg0dr_modules`
--

DROP TABLE IF EXISTS `vg0dr_modules`;
CREATE TABLE IF NOT EXISTS `vg0dr_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `vg0dr_modules`
--

INSERT INTO `vg0dr_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `vg0dr_modules_menu`
--

DROP TABLE IF EXISTS `vg0dr_modules_menu`;
CREATE TABLE IF NOT EXISTS `vg0dr_modules_menu` (
...
--
-- Dumping data for table `vg0dr_modules_menu`
--

INSERT INTO `vg0dr_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `vg0dr_newsfeeds`
--

DROP TABLE IF EXISTS `vg0dr_newsfeeds`;
CREATE TABLE IF NOT EXISTS `vg0dr_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `vg0dr_overrider`
--

DROP TABLE IF EXISTS `vg0dr_overrider`;
CREATE TABLE IF NOT EXISTS `vg0dr_overrider` (
...
--
-- Table structure for table `vg0dr_postinstall_messages`
--

DROP TABLE IF EXISTS `vg0dr_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `vg0dr_postinstall_messages` (
...
--
-- Dumping data for table `vg0dr_postinstall_messages`
--

INSERT INTO `vg0dr_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `vg0dr_redirect_links`
--

DROP TABLE IF EXISTS `vg0dr_redirect_links`;
CREATE TABLE IF NOT EXISTS `vg0dr_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `vg0dr_schemas`
--

DROP TABLE IF EXISTS `vg0dr_schemas`;
CREATE TABLE IF NOT EXISTS `vg0dr_schemas` (
...
--
-- Dumping data for table `vg0dr_schemas`
--

INSERT INTO `vg0dr_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.3-2014-02-20');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_session`
--

DROP TABLE IF EXISTS `vg0dr_session`;
CREATE TABLE IF NOT EXISTS `vg0dr_session` (
...
--
-- Dumping data for table `vg0dr_session`
--

INSERT INTO `vg0dr_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('3fdbgkvdk2k98jdquier6ruth5', 1, 0, '1398782668', '__default|a:8:{s:15:"session.counter";i:9;s:19:"session.timer.start";i:1398782355;s:18:"session.timer.last";i:1398782626;s:17:"session.timer.now";i:1398782665;s:22:"session.client.browser";s:65:"Mozilla/5.0 (Windows NT 5.1; rv:28.0) Gecko/20100101 Firefox/28.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":3:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";s:12:"redirect_url";N;}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"724";s:4:"name";s:10:"Super User";s:8:"username";s:8:"webadmin";s:5:"email";s:20:"arvindpdmn@gmail.com";s:8:"password";s:34:"$P$DN74a2qSFBM3TxYuhiwy/xXgONn4he.";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-04-29 14:20:58";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"b5516a29c0cc115a1bd1d3de0f561f05";}', 724, 'webadmin'),
('v0a8e3e3h1skugf7jfb8880e35', 0, 1, '1398782163', '__default|a:8:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1398781315;s:18:"session.timer.last";i:1398781315;s:17:"session.timer.now";i:1398782161;s:22:"session.client.browser";s:65:"Mozilla/5.0 (Windows NT 5.1; rv:28.0) Gecko/20100101 Firefox/28.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"3dd339c86187fdebcddcb0481510e484";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_tags`
--

DROP TABLE IF EXISTS `vg0dr_tags`;
CREATE TABLE IF NOT EXISTS `vg0dr_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `vg0dr_tags`
--

INSERT INTO `vg0dr_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 724, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 724, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_template_styles`
--

DROP TABLE IF EXISTS `vg0dr_template_styles`;
CREATE TABLE IF NOT EXISTS `vg0dr_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vg0dr_template_styles`
--

INSERT INTO `vg0dr_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '1', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'yoo_master2', 0, '0', 'yoo_master2 - Default', '{"config":""}');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_ucm_base`
--

DROP TABLE IF EXISTS `vg0dr_ucm_base`;
CREATE TABLE IF NOT EXISTS `vg0dr_ucm_base` (
...
--
-- Dumping data for table `vg0dr_ucm_base`
--

INSERT INTO `vg0dr_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_ucm_content`
--

DROP TABLE IF EXISTS `vg0dr_ucm_content`;
CREATE TABLE IF NOT EXISTS `vg0dr_ucm_content` (
...
--
-- Dumping data for table `vg0dr_update_sites`
--

INSERT INTO `vg0dr_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1398782390, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1398782390, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1398782391, '');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_update_sites_extensions`
--

DROP TABLE IF EXISTS `vg0dr_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `vg0dr_update_sites_extensions` (
...
--
-- Dumping data for table `vg0dr_update_sites_extensions`
--

INSERT INTO `vg0dr_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `vg0dr_updates`
--

DROP TABLE IF EXISTS `vg0dr_updates`;
CREATE TABLE IF NOT EXISTS `vg0dr_updates` (
...
--
-- Dumping data for table `vg0dr_updates`
--

INSERT INTO `vg0dr_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(42, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
...
(47, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.2.3.3', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
...
(50, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(51, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.2.3.2', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(54, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(55, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(56, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(57, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(58, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(59, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_user_keys`
--

DROP TABLE IF EXISTS `vg0dr_user_keys`;
CREATE TABLE IF NOT EXISTS `vg0dr_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `vg0dr_user_notes`
--

DROP TABLE IF EXISTS `vg0dr_user_notes`;
CREATE TABLE IF NOT EXISTS `vg0dr_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `vg0dr_user_profiles`
--

DROP TABLE IF EXISTS `vg0dr_user_profiles`;
CREATE TABLE IF NOT EXISTS `vg0dr_user_profiles` (
...
--
-- Table structure for table `vg0dr_user_usergroup_map`
--

DROP TABLE IF EXISTS `vg0dr_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `vg0dr_user_usergroup_map` (
...
--
-- Dumping data for table `vg0dr_user_usergroup_map`
--

INSERT INTO `vg0dr_user_usergroup_map` (`user_id`, `group_id`) VALUES
(724, 8);

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_usergroups`
--

DROP TABLE IF EXISTS `vg0dr_usergroups`;
CREATE TABLE IF NOT EXISTS `vg0dr_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `vg0dr_usergroups`
--

INSERT INTO `vg0dr_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `vg0dr_users`
--

DROP TABLE IF EXISTS `vg0dr_users`;
CREATE TABLE IF NOT EXISTS `vg0dr_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `vg0dr_users`
--

INSERT INTO `vg0dr_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(724, 'Super User', 'webadmin', 'arvindpdmn@gmail.com', '$P$DN74a2qSFBM3TxYuhiwy/xXgONn4he.', 0, 1, '2014-04-29 14:20:58', '2014-04-29 14:39:37', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `vg0dr_viewlevels`
--

DROP TABLE IF EXISTS `vg0dr_viewlevels`;
CREATE TABLE IF NOT EXISTS `vg0dr_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `vg0dr_viewlevels`
--

INSERT INTO `vg0dr_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `vg0dr_weblinks`
--

DROP TABLE IF EXISTS `vg0dr_weblinks`;
CREATE TABLE IF NOT EXISTS `vg0dr_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
